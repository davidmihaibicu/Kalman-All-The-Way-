-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\kalman_ac_sim\Innovation.vhd
...
-- 
-- Module: Innovation
-- Source Path: kalman_ac_sim/Kalman DUT/Innovation
-- Hierarchy Level: 1
-- Model version: 1.65
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF Innovation IS
  ...
  SIGNAL delayMatch1_reg                  : vector_of_signed32(0 TO 7);  -- sfix32 [8]
...
BEGIN
  ...
  BEGIN
    ...
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
        delayMatch1_reg(0 TO 3) <= z_k_signed(0 TO 3);
        delayMatch1_reg(4 TO 7) <= delayMatch1_reg(0 TO 3);
      END IF;
    END IF;
  END PROCESS delayMatch1_process;

  z_k_1(0 TO 3) <= delayMatch1_reg(4 TO 7);
